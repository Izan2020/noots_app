  ...
  PreferredSizeWidget homeAppBar(
    ...
    return AppBar(
        ...
        leading: AnimatedOpacity(
          ...
          opacity: noteState == NoteState.empty ? 0 : 1.0,
          child: Row(
            children: [
              GestureDetector(
...
class ItemNotes extends StatefulWidget {
  ...
  bool isDeleteState;
  Function onTapItem;
  Function onSlidableItem;
  ItemNotes({
    Key? key,
    required this.notes,
    required this.isDeleteState,
    required this.onTapItem,
    required this.onSlidableItem,
  }) : super(key: key);
    ...
    return Slidable(
      startActionPane: ActionPane(motion: const ScrollMotion(), children: [
        SlidableAction(
          ...
          onPressed: (context) => widget.onSlidableItem(),
          ...
          AnimatedContainer(
            ...
            child: Visibility(
                ...
                child: AnimatedOpacity(
                  duration: const Duration(milliseconds: 300),
                  opacity: widget.isDeleteState ? 1.0 : 0,
                  child: Checkbox(
